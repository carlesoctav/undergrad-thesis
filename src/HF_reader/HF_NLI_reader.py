...
class HF_NLI_reader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print(sentence_1)
        inputs_1 = self.tokenizer(sentence_1, max_length=self.max_token, padding='max_length')
        inputs_2 = self.tokenizer(sentence_2, max_length=self.max_token, padding='max_length')
