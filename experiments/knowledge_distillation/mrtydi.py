...
corpus, queries, qrels = GenericDataLoader(data_folder=data_path + "/indonesian").load(
    split="test"
)
...
faiss_search = FlatIPFaissSearch(model, batch_size=512)
...
prefix = "indobert-mmarco-knowledge-distillation"
ext = "flat"
